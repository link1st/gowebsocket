...
本文内容比较长，如果直接想clone项目体验直接进入[4、goWebSocket 项目](#4goWebSocket-项目),文本从介绍webSocket是什么开始，然后开始介绍这个项目，以及在Nginx中配置域名做webSocket的转发，然后介绍如何搭建一个分布式系统。
...
- 本文虽然号称单台机器能有百万长链接(内存上能满足)，但是实际在场景远比这个复杂(cpu有些压力)，当然了如果你有这么大的业务量可以购买更多的机器更好的去支撑你的业务
