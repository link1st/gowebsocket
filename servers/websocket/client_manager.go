...
func (manager *ClientManager) EventLogin(login *login) {
	...
	SendRoomMsg(login.AppID, roomID, login.UserID, orderID, models.MessageCmdEnter, "哈喽~")
}
...
func (manager *ClientManager) EventUnregister(client *Client) {
	...
	if client.UserID != "" {
		...
		SendRoomMsg(client.AppID, roomID, client.UserID, orderID, models.MessageCmdExit, "用户已经离开~")
	}
}
